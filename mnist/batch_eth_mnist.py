...
for epoch in range(n_epochs):
    ...
    for step, batch in enumerate(tqdm(dataloader)):
        ...
        if step % update_steps == 0 and step > 0:
            ...
            df.to_csv('/home/gidia/anaconda3/envs/myspace/examples/mnist/outputs/test_'+'Rand'+'_'+str(n_neurons)+'_'+str(batch_size)+'_'+str(nu_single)+'_'+str(nu_pair)+'_'+str(n_epochs)+'_'+str(emax)+'_'+str(emin)+'_'+str(inh)+'.csv', index=False)
        ...
        network.run(inpts=inpts, time=time, one_step=False)
