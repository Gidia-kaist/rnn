...
for epoch in range(n_epochs):
    ...
    for step, batch in enumerate(tqdm(dataloader)):
        ...
        if step % update_steps == 0 and step > 0:
            ...
            df.to_csv('/home/gidia/anaconda3/envs/myspace/examples/mnist/outputs/test_'+'Rand'+'_'
                      +str(n_neurons)+'_'
                      +str(batch_size)+'_'
                      +str(nu_single)+'_'
                      +str(nu_pair)+'_'
...
'''
input_exc_weights = network.connections[("X", "Ae")].w
seed_weight = input_exc_weights.view(784, n_neurons)
with open('/home/gidia/anaconda3/envs/myspace/examples/mnist/log/weight_seed.p', 'wb')as file:
    pickle.dump(seed_weight, file)
